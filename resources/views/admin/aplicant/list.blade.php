...
@section('content')
    <div class="bg-white p-4 mb-8 text-start text-sm">
        <h2 class="text-lg font-semibold mb-4">Daftar Nama Beasiswa yang Sedang Berlangsung</h2>
                    ...
                    @foreach ($scholarships as $item)
                        <tr
                            ...
                            <td class="p-2 border table-fixed border-gray-300"><a
                                    href="{{ route('aplicant.index', ['scholarship_id' => $item->scholarship->id]) }}">{{ $item->scholarship->name }}</a>
                            </td>
