                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('biodata.update') }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        <label for="account_holder_name" class="form-label font-semibold text-base">Nama
                                            Pada
                                            Rekening:</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="parent_income" class="form-label font-semibold text-base">Penghasilan
                                            Orang
                                            Tua:</label>
                                        <select name="parent_income"
                                            ...
                                            value="{{ old('parent_name', $user->parent_) }}" required>
                                    ...
                                    <div class="mb-3">
                                        <label for="email" class="form-label font-semibold text-base">Email
                                            Mahasiswa:</label>
